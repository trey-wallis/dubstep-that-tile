	...
	return (
		<div className="Options" style={{width: '320px'}}>
			...
			<div className="Options__username flex justify-center">
				Username <input type="text" className="Options__field-username ml2 bg-color--black-t1" placeholder="New User" defaultValue={ LevelStore.username } onChange={(e) => { LevelStore.username = e.target.value }} />
			</div>
