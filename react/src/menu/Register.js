		...
		<div className="Register">
			...
			<div className="f3-ns f4 tc mt4">Register</div>
				<div className="Register__form flex flex-wrap justify-center mt2">
					...
					<input className="outlne--none bg-color--black-t1 bw0 outline--none f4-ns f5 mb3" type="text" defaultValue="Username" />
					<div className="b">Password</div>
					<input className="bg-color--black-t1 bw0 outline--none f4-ns f5 mb3" type="password" defaultValue="Password" />
					<div className="b">Repeat Password</div>
					<input className="bg-color--black-t1 bw0 outline--none f4-ns f5 mb3" type="password" defaultValue="Repeat Password" />
